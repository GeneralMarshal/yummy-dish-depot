...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Add your signup logic here (e.g., axios.post(...))
    try{
      const res = await axios.post("http://localhost:4000/user/signup", {email, password})
      ...
      <div className="w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-orange-100 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Sign up with your email</p>
          </div>
